...
<div class="row">
  <div class="leftcolumn">
	<div class="en_tete_bloc_left"><h3 style="  background: linear-gradient(to right, #c4a218, white);color:white;">Contenu decisions/conseils : Textes et documents du cameroun</h3>  </div>
		<div class="card1">
	
          <h3 style="color:grey;">Volume 1 : </h3>
		  <h3 style="color:grey;">Tome 1 : </h3>
		  <h3 style="color:grey;">Decision : </h3>
